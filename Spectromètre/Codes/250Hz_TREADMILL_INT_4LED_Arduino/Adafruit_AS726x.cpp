...
/*! NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW
    @brief  Set the i2c clock speed of the sensor.
    @param time the i2c SCL frequency clock speed
*/
/**************************************************************************/
void Adafruit_AS726x::setSpeed(uint32_t time) {
i2c_dev->setSpeed(time);  
}
